...
objectManager.getObjectList('House',{
index:'sale',
type:'house',
body:{
query:{
...
objectManager.getOneObject('House',{id:(0,_graphqlRelay.fromGlobalId)(id).id}));}}};
